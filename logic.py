...
class Pokemon:
    ...
    async def info(self):
        ...
        return f"Pokémonunuzun ismi: {self.name},Pokemonun Gücü:{self.power},Pokemonun Sağlığı:{self.hp}"  # Pokémon adını içeren dizeyi döndürür
...
async def main():
    ...
    fighter = Fighter("@atahan")

    

    # await ile coroutine'leri çağırıyoruz
